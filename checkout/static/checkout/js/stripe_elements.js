...
form.addEventListener('submit', function(ev) {
  ...
  $.post(url, postData).done(function() {
    ...
    // Add failure function which will be triggered if our view
    // sends a 400 bad request response, that reloads the page to show
    // the user the error message from the view
    }).fail(function() {
